# [Material Dashboard](https://appseed.us/product/material-dashboard/) Flask/Jinja

Open-source **Flask/Jinja Template** generated by `AppSeed` op top of **[Material Dashboard](https://appseed.us/product/material-dashboard/)**, a modern `Bootstrap 5` dashboard design. The project is a super simple Flask project WITHOUT database, ORM, or any other hard dependency. The project can be used as a codebase for future project or to migrate the Jinja files and assets to a legacy Python-based project that uses Jinja as template engine (Flask, Bottle, Django).
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d4c0ac53-44af-40d8-b6b6-b6f8d01f2f85.git
$ cd d4c0ac53-44af-40d8-b6b6-b6f8d01f2f85
```
...
---
[Material Dashboard](https://appseed.us/product/material-dashboard/) Flask/Jinja - Open-source starter generated by **[AppSeed Generator](https://appseed.us/generator/)**.
